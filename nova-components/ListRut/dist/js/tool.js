...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_loading_overlay_dist_vue_loading_css__ = __webpack_require__(6);
    ...
    methods: {
        ...
        sendfile: function sendfile() {
            ...
            if (this.myFile.name.split(".").pop() == "xlsx" || this.myFile.name.split(".").pop() == "xlsm" || this.myFile.name.split(".").pop() == "xlsb" || this.myFile.name.split(".").pop() == "xltx" || this.myFile.name.split(".").pop() == "xltm" || this.myFile.name.split(".").pop() == "xlt" || this.myFile.name.split(".").pop() == "xls" || this.myFile.name.split(".").pop() == "xml" || this.myFile.name.split(".").pop() == "xml" || this.myFile.name.split(".").pop() == "xlam" || this.myFile.name.split(".").pop() == "xla" || this.myFile.name.split(".").pop() == "xlw" || this.myFile.name.split(".").pop() == "XLR" || this.myFile.name.split(".").pop() == "csv") {
                ...
                axios.post("/nova-vendor/list-rut/send", formData, requestConfig).then(function (response) {
                    _this.is_loadin = 0;
                    _this.errors = "";
        ...
        getUserRut: function getUserRut() {
            ...
            this.isLoading = true;
            axios.get("/nova-vendor/list-rut/getUserRut").then(function (data) {
...
var render = function() {
  ...
  return _c(
    "div",
    { ref: "tool", staticClass: "relative", attrs: { id: "tool" } },
    [
      _c("heading", { staticClass: "mb-3" }, [_vm._v("Listado de usuarios")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "\n        El formato del archivo debe ser excel o csv. Descargar ejemplo\n        "
        ),
        _c("a", { attrs: { href: this.url + "Ruts_para_encuesta.xlsx" } }, [
          _vm._v("\n            Aquí\n        ")
        ])
      ]),
      _vm._v(" "),
      _c("card", { staticClass: "overflow-hidden" }, [
          ...
          _c("div", { staticClass: "flex border-b border-40" }, [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              _c(
                ...
                _vm._l(_vm.userRutLists, function(userRutList) {
                  return _c(
                    "option",
                    {
                      key: userRutList.id,
                      domProps: { value: userRutList.id }
                    },
                    [
                      _vm._v(
                        "\n                            " +
                          _vm._s(userRutList.name) +
                          "\n                        "
                      )
                    ]
                  )
        ...
        _c("div", { staticClass: "bg-30 flex px-8 py-4" }, [
          ...
          _c("img", {
            ...
            attrs: { src: this.url + "loading.gif" }
          })
        ])
      ])
    ],
